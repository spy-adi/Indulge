...
const sector = [];
  ...
  sector.push(<Option key={"Analytics"}>{"Analytics"}</Option>);
  sector.push(<Option key={"Consulting"}>{"Consulting"}</Option>);
  sector.push(<Option key={"Core-Technical"}>{"Core(Technical)"}</Option>);
  sector.push(<Option key={"BFSI"}>{"BFSI"}</Option>);
  sector.push(<Option key={"IT/Software"}>{"IT/Software"}</Option>);
  sector.push(<Option key={"Ed-Tech"}>{"Ed Tech"}</Option>);
  sector.push(<Option key={"E-Commerce"}>{"E-commerce"}</Option>);
...
btech4yr.push(<Option key={"bci"}>{"Civil Engineering"}</Option>);
...
test.push(<Option key={"Technical"}>{"Technical"}</Option>);
test.push(<Option key={"Aptitude"}>{"Aptitude"}</Option>);
test.push(<Option key={"Both"}>{"Both"}</Option>);
test.push(<Option key={"None"}>{"None"}</Option>);

const qround = [];

qround.push(<Option key={"GD"}>{"Group Discussion"}</Option>);
qround.push(<Option key={"Case Study"}>{"Case Study"}</Option>);
qround.push(<Option key={"Interview"}>{"Interview"}</Option>);
