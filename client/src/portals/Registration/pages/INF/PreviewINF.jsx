...
function PreviewINF() {
  ...
  const {infssu,getInf} = infContext;
  useEffect(()=>{
  ...
  return (
    ...
    <Form.Item label="Requirement of B.Tech Students?">
        <Select defaultValue="y" style={{ width: 120 }} onChange={handleChange} disabled={edit}>
 ...
 <div className='c2 border border-2 rounded'>
    ...
    >
      ...
      <Upload {...props} >
            <Button disabled={edit} icon={<UploadOutlined />}>Click to Upload</Button>
        </Upload>
      </Form.Item>
